...
urlpatterns = [
    ...
    path('accounting/full-report/download/public/', accounting_views.public_download_report_pdf, name='public_download_report_pdf'),
    path('members/unpaid-report/public/', views.public_download_unpaid_report, name='public_download_unpaid_report'),
]
